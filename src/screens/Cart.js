...
export default function Cart() {
    ...
    if (data.length === 0){
        return (<div className="m-5 w-100 text-center fw-bold fst-italic fs-5">The Cart Is Empty!</div>)
    }
  ...
  return (
    <div>
      <div className="container m-auto  table-responsive table-responsive-sm table-responsive-md">
       ...
       <div> <button className="btn btn-success mt-5">Check Out</button></div>
